...
public class JavaExample_20_Abstraction 
{
	...
	// or applying brakes will stop the car but he does not know about how on pressing 
	// the accelerator the speed is actually increasing, he does not know about the 
	// inner mechanism of the car or the implementation of accelerator, brakes etc 
