...
public class JavaExample_11_ForLoopInJavaImportant 
{
	public static void main(String[] args) 
	{
        ...
        // Redeclaration of a variable in initialization block : Suppose, an initialization variable is already declared as integer. 
        ...
        // Variables in the loop are accessible only within: The variables that are declared in the initialization block can be 
        // accessed only within the loop.
